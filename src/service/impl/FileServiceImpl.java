...
public class FileServiceImpl implements FileService{
	...
	public void fileupload(HttpServletRequest req, HttpServletResponse resp) {
		...
		// TEST
		// D:\workspace_web\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\FileUpload\tmp
		// localhost:8088/tmp
		// D:\workspace-web\FileUpload\WebContent\tmp
	...
	public UploadFile getList(UploadFile uploadFile) {
		return filedao.select(uploadFile);
	}
	...
	public UploadFile getFileParam(HttpServletRequest req) {
		...
		if (param != null && !"".equals(param)) {
			uploadfile.setFileno(Integer.parseInt(param));
		}
		
		// OriginName
		param = req.getParameter("OriginName");
		uploadfile.setOriginName(param);
		// StoredName
		param = req.getParameter("StoredName");
		uploadfile.setStoredName(param);
